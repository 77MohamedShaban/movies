...
class _BrowseClient implements BrowseClient {
  _BrowseClient(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<MovieResponse> fetchMoviesByGenre(String genre, int page) async {
